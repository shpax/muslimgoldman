...
(function() {
    var menuTabs = [].slice.call(document.querySelectorAll('.product-tabs li'));
    menuTabs.forEach(function (li) {
        li.onclick = function () {
            menuTabs.forEach(function (tab) {
                if (tab != li) {
                    tab.classList.remove('active');
                    document.querySelector(tab.getAttribute('data-selector')).classList.add('hidden');
                } else {
                    tab.classList.add('active');
                    document.querySelector(tab.getAttribute('data-selector')).classList.remove('hidden');
                }
            });
        }
    })
