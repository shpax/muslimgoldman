...
function dimox_breadcrumbs() {
  ...
  $wrap_before = '<div class="breadcrumbs" style="
...
function et_excerpt_more($more) {
    ...
    global $post;
    return '<div class="view-full-post"><a href="'. get_permalink($post->ID) . '" class="view-full-post-btn">Подробнее</a></div>;';
}
